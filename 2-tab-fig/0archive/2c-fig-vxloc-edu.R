...
# vaccination location by student race
########################################
...
data.y4=data.y4[data.y4$edu!="Error",]
data.y4$edu=droplevels(data.y4$edu)
...
graph1415.o=as.data.frame(prop.table(table(data$edu[data$vx1415==1 & data$dist=="OUSD"],
    data$vxloc1415[data$vx1415==1 & data$dist=="OUSD"]),1))
graph1415.w=as.data.frame(prop.table(table(data$edu[data$vx1415==1 & data$dist=="WCCUSD"],
    data$vxloc1415[data$vx1415==1 & data$dist=="WCCUSD"]),1))
colnames(graph1415.o)=c("edu","loc","percent")
colnames(graph1415.w)=c("edu","loc","percent")
graph1415.o$yr="Yr 1"
graph1415.w$yr="Yr 1"
graph1415.o$dist="OUSD"
graph1415.w$dist="WCCUSD"

graph1516.o=as.data.frame(prop.table(table(data$edu[data$vx1516==1 & data$dist=="OUSD"],
    data$vxloc1516[data$vx1516==1 & data$dist=="OUSD"]),1))
graph1516.w=as.data.frame(prop.table(table(data$edu[data$vx1516==1 & data$dist=="WCCUSD"],
    data$vxloc1516[data$vx1516==1 & data$dist=="WCCUSD"]),1))
colnames(graph1516.o)=c("edu","loc","percent")
colnames(graph1516.w)=c("edu","loc","percent")
graph1516.o$yr="Yr 2"
graph1516.w$yr="Yr 2"
graph1516.o$dist="OUSD"
graph1516.w$dist="WCCUSD"

graph1617.o=as.data.frame(prop.table(table(data$edu[data$vx1617==1 & data$dist=="OUSD"],
    data$vxloc1617[data$vx1617==1 & data$dist=="OUSD"]),1))
graph1617.w=as.data.frame(prop.table(table(data$edu[data$vx1617==1 & data$dist=="WCCUSD"],
    data$vxloc1617[data$vx1617==1 & data$dist=="WCCUSD"]),1))
colnames(graph1617.o)=c("edu","loc","percent")
colnames(graph1617.w)=c("edu","loc","percent")
graph1617.o$yr="Yr 3"
graph1617.w$yr="Yr 3"
graph1617.o$dist="OUSD"
graph1617.w$dist="WCCUSD"

graph1718.o=as.data.frame(prop.table(table(data.y4$edu[data.y4$vx1718==1 & data.y4$dist=="OUSD"],
         data.y4$vxloc1718[data.y4$vx1718==1 & data.y4$dist=="OUSD"]),1))
graph1718.w=as.data.frame(prop.table(table(data$edu[data.y4$vx1718==1 & data.y4$dist=="WCCUSD"],
        data.y4$vxloc1718[data.y4$vx1718==1 & data.y4$dist=="WCCUSD"]),1))
colnames(graph1718.o)=c("edu","loc","percent")
colnames(graph1718.w)=c("edu","loc","percent")
graph1718.o$yr="Yr 4"
graph1718.w$yr="Yr 4"
...
pdf(file=paste0(plot.dir,"fig-vxloc-edu-y4.pdf"),width=8,height=4)
